...
<?
   ...
   $stmt= $db->prepare($query2,array(PDO::ATTR_CURSOR => PDO::CURSOR_SCROLL));
	$stmt->bindParam(':id_evento2',$id_evento2);
	$stmt->execute();
...
<?php }/* fin sección albums */?>


<?php if ($habilitar_equipos){ ?>
...
?>
    <li><a href=""><span class="down">admin</span></a>
       ...
       <li>
          ...
          <li><a href=""><span class="down">Jugadores</span></a>
            <ul>
               <li><a href="index.php?accion=jugador_nuevo">Jugador Nuevo</a></li>
               <li><a href="index.php?accion=jugador_buscar">Buscar Jugador</a></li>
			   <li><a href="index.php?accion=jugador_carga_masiva">Carga por equipo</a></li>
            </ul>
